export default {
    ...
    page: {
        ...
        index: {
            title: 'FastConvert — Fast Online File Converter',
            description: 'FastConvert is an easy and free way to convert files online. We support a wide range of formats for documents, images, audio, and video.'
        },
        error: {
            page_not_found: "Page not found",
            not_found_text: "It seems the page you're looking for doesn't exist or has been moved.",

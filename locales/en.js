export default {
    ...
    titles: {
        ...
        category: {
            image: 'Конвертировать изображения <br> бесплатно онлайн'
        },
        index: 'Онлайн конвертер файлов: <br> быстро, легко и бесплатно'
    },
    subtitles: {
    ...
    search_empty: 'Nothing found. Try changing your query.',
    meta: {
        title: {
            suffix: '',
        },
    ...
    page: {
        ...
        index: {
            title: 'Online File Converter - Fast and Free Conversion',
            description: 'Easily convert your files online for free. Support for images, videos, documents, and over 200 formats. Fast, secure, and without registration!'
        },
        privacy: {
        ...
        error: {
            ...
            not_found_text: "It seems the page you're looking for doesn't exist or has been moved. Let's return to the homepage or use the search.",
            ...
            error_default_message: "An error occurred. Please try refreshing the page or come back later."
        }
    },
    breadcrumb: {
        items: {
